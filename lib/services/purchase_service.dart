...
/// Singleton in-app purchase service for Snake Classic.
///
/// Only product: a non-consumable "Remove Ads" entitlement.
/// Logical id: 'noads'. iOS platform id: 'noads_snake'. Android: 'noads'.
/// Persisted in SharedPreferences under 'noAds_snake'.
class PurchaseService {
  ...
  static const _kNoAdsKey = 'noAds_snake';

  static String _platformId(String logicalId) =>
      Platform.isIOS ? '${logicalId}_snake' : logicalId;

  static String _logicalId(String platformId) =>
      platformId.endsWith('_snake')
